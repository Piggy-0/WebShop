...
private WebDriver driver;
	...
	@Test(priority = 2)
	public void timKiemOrder() throws InterruptedException {
		...
		WebElement inputSearch = driver.findElement(By.xpath("//*[@id=\"layoutSidenav_content\"]/app-list-donhang/div[3]/div/input"));
		inputSearch.sendKeys("10");
		Thread.sleep(1000);
		
		WebElement btnSearch = driver.findElement(By.xpath("//*[@id=\"layoutSidenav_content\"]/app-list-donhang/div[3]/div/button"));
		btnSearch.click();
		Thread.sleep(2000);
		
		driver.quit();
		System.out.println("Tìm đơn hàng thành công!");
	}
}
